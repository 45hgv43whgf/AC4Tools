...
echo AC4Tools v1.02
 ...
 echo - Player: Player Godmode, Infinite Breath, Stealth Mode, No Reload, No Fall Damage, Allow Eagle Vision while sprinting, Lock Consumables ^(incl Ship Ammo^), One-time Inventory Refill, Freeze Mission Timer.
